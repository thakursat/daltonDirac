type CurriclumData = {
  ...
  id: number;
  handleCurriculumToggle: (id: number) => void;
  title: string;
  content: string;
};

const CurriculumItem = ({ curriculumData }: { curriculumData: CurriclumData }) => {
  const { activeCurriculum: activeFaq, id, handleCurriculumToggle: handleFaqToggle, title: quest, content: ans } = curriculumData;
